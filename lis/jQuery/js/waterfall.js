    ...
    window.onscroll=function(){
        if(checkscrollside()){
            $.each( data, function( index, value ){
                ...
                $('<img>').attr('src','./images/' + value + '.jpg').appendTo($oBox);
                $('<p>').appendTo($oBox).html('简约宜家风');
                var $oitem = $('<div>').addClass('item').appendTo($oBox).html('<img src="./images/user.jpeg" alt="">');
                $('<span>').appendTo($oitem).html('<a href="#" title="">清风徐来</a><br>来自<a href="#">家装</a>');
            });
            waterfall();
        };
    }
